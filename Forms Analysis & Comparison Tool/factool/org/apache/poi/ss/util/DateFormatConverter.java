...
public class DateFormatConverter
{
    ...
    private static Map<String, String> localePrefixes;
    ...
    public static String getPrefixForLocale(final Locale locale) {
        ...
        String result = DateFormatConverter.localePrefixes.get(localeString);
        if (result == null) {
            result = DateFormatConverter.localePrefixes.get(localeString.substring(0, 2));
            if (result == null) {
                final Locale parentLocale = new Locale(localeString.substring(0, 2));
                DateFormatConverter.logger.log(7, "Unable to find prefix for " + locale + "(" + locale.getDisplayName() + ") or " + localeString.substring(0, 2) + "(" + parentLocale.getDisplayName() + ")");
                return "";
            }
        }
        return result;
    ...
    static {
        ...
        DateFormatConverter.localePrefixes = prepareLocalePrefixes();
    }
