...
public class CodePageUtil
{
    ...
    public static byte[] getBytesInCodePage(final String string, final int codepage) throws UnsupportedEncodingException {
        final String encoding = codepageToEncoding(codepage);
        return string.getBytes(encoding);
    }
    
    public static String getStringFromCodePage(final byte[] string, final int codepage) throws UnsupportedEncodingException {
        return getStringFromCodePage(string, 0, string.length, codepage);
    }
    
    public static String getStringFromCodePage(final byte[] string, final int offset, final int length, final int codepage) throws UnsupportedEncodingException {
        final String encoding = codepageToEncoding(codepage);
    ...
    public static String codepageToEncoding(final int codepage, final boolean javaLangFormat) throws UnsupportedEncodingException {
        if (codepage <= 0) {
